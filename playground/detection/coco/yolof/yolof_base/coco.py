...
from cvpods.data.datasets.paths_route import _PREDEFINED_SPLITS_COCO
_PREDEFINED_SPLITS_COCO['dataset_type']='COCODatasetYOLOF'
...
@DATASETS.register()
class COCODatasetYOLOF(BaseDataset):
    def __init__(self, cfg, dataset_name, transforms=[], is_train=True):
        super(COCODatasetYOLOF, self).__init__(cfg, dataset_name, transforms, is_train)
